!function (e, t) {
    ...
    return function (e) {
        function t(t) {
            for (var n, o, r = t[0], a = t[1], c = 0, s = []; c < r.length; c++) o = r[c], Object.prototype.hasOwnProperty.call(i, o) && i[o] && s.push(i[o][0]), i[o] = 0;
        ...
        }, o.p = "https://cdn.jsdelivr.net/npm/minivaline@3.1.5/dist/", o.oe = function (e) {
            throw console.error(e), e
        };
        var r = window.webpackJsonpMiniValine = window.webpackJsonpMiniValine || [], a = r.push.bind(r);
        r.push = t, r = r.slice();
        ...
        var i = {
            on: function (e, t, n, o) {
                for (var r = 0, a = (e = e.split(" ")).length; r < a; r++) i.off(e[r], t, n, o), t.addEventListener ? t.addEventListener(e[r], n, o || !1) : t.attachEvent ? t.attachEvent("on".concat(e[r]), n) : t["on".concat(e[r])] = n
            }, off: function (e, t, n, i) {
                for (var o = 0, r = (e = e.split(" ")).length; o < r; o++) t.removeEventListener ? t.removeEventListener(e, n, i || !1) : t.detachEvent ? t.detachEvent("on".concat(e), n) : t["on".concat(e)] = null
            }
        };
        e.exports = i
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0}), t.VERSION = "3.1.5", t.GBUrl = "https://gravatar.loli.net/avatar/", t.EUrl = ["https://cdn.jsdelivr.net/npm/alus@latest", "https://cdn.jsdelivr.net/gh/MiniValine/qq@master", "https://cdn.jsdelivr.net/gh/MiniValine/Bilibilis@master", "https://cdn.jsdelivr.net/gh/MiniValine/tieba@master", "https://cdn.jsdelivr.net/gh/MiniValine/twemoji@master", "https://cdn.jsdelivr.net/gh/MiniValine/weibo@master"], t.pf = "https://cdn.polyfill.io/v3/polyfill.min.js?features=es6", t.i18nUrl = "https://cdn.jsdelivr.net/gh/MiniValine/minivaline-i18n@latest/", t.DEHash = "9e63c80900d106cbbec5a9f4ea433a3e", t.MaxNL = 6, t.PS = 6, t.C = {
            ip: "",
            comment: "",
            rid: "",
            at: "",
        ...
        e.exports = function (e) {
            ...
            var t = i(e.data);
            if (window.XMLHttpRequest) var n = new XMLHttpRequest; else n = new ActiveXObject("Microsoft.XMLHTTP");
        ...
        e.exports = function (e, t) {
            Promise.all([n.e(15), n.e(17)]).then(n.t.bind(null, 56, 7)).then((function (n) {
                var i = n.XSS;
                e.TEXT = i(e.TEXT), t(e)
            }))
        }
        ...
        e.exports = function (e, t) {
            if (document.selection) e.focus(), document.selection.createRange().text = t, e.focus(); else if (e.selectionStart || "0" == e.selectionStart) {
                var n = e.selectionStart, i = e.selectionEnd, o = e.scrollTop;
                e.value = e.value.substring(0, n) + t + e.value.substring(i, e.value.length), e.focus(), e.selectionStart = n + t.length, e.selectionEnd = n + t.length, e.scrollTop = o
        ...
        e.exports = function (e) {
            ...
            if (t) {
                ...
                for (var n = ["nick", "link", "mail"], o = 0; o < n.length; o++) {
                    var r = n[o];
                    e.el.querySelector(".v".concat(r)).value = t[r], e.C[r] = t[r]
                }
                "" !== t.mail && "DesertsP" === e.mode && e.el.querySelector(".visitor_avatar").setAttribute("data-src", "".concat(i.GBUrl + md5(t.mail.toLowerCase().trim()), "?size=80&d=robohash"))
            }
        }
    }, function (e, t, n) {
        "use strict";
        ...
        e.exports = function (e, t, n) {
            ...
            if (o) for (var r = 0; r < o.length; r++) {
                var a = o[r].match(/!\(:(.*?\.\w+):\)/)[1], c = e.emoticon[a],
        ...
        var i = function (e) {
            return e && e.__esModule ? e : {default: e}
        }(n(9)), o = n(1), r = function (e) {
            return window.MV || (console.log("%c MiniValine %c v" + o.VERSION + " ", "color: white; background: #0078E7; padding:5px 0;", "padding:4px;border:1px solid #0078E7;"), window.MV = {}, window.MV.v = o.VERSION), new i.default(e)
        };
        e.exports = r, e.exports.default = r
    }, function (e, t, n) {
        "use strict";
        var i = r(n(10)), o = r(n(16));
        ...
        var a = function (e) {
            var t = this;
            try {
                t.config = e, o.default.Config(t), o.default.initStyle(t), o.default.ActivateCode(t), o.default.script(t), o.default.i18n(t), o.default.initLibs(t)
            } catch (e) {
            }
        };
        a.prototype.initCheck = function () {
            ...
            try {
                var t = setInterval((function () {
                    void 0 !== e.i18n && (clearInterval(t), "DesertsP" === e.mode ? n.e(2).then(n.t.bind(null, 47, 7)).then((function (t) {
                        var n = t.getEle;
                        e.ele = n(e), e.initBody()
                    })) : "xCss" === e.mode && (e.config.closeUA || n.e(12).then(n.t.bind(null, 48, 7)).then((function (e) {
                        (0, e.init)()
                    })), n.e(3).then(n.t.bind(null, 49, 7)).then((function (t) {
                        var n = t.getEle;
                        e.ele = n(e), e.initBody()
                    }))))
                }), 5)
            ...
            var e = this;
            try {
                i.default.el(e), i.default.loading(e), e.nodata.show(), i.default.smiles(e), o.default.setAV(e)
            } catch (e) {
                return
            }
            try {
                o.default.cloudFlag(e), e.loading.hide(e.parentCount), e.loading.show(), o.default.initCount(e), e.bind()
            } catch (e) {
            }
        }, a.prototype.bind = function () {
            var e = this;
            o.default.insertComment(e, i.default), o.default.parentQuery(e), o.default.nestQuery(e), o.default.alert(e), o.default.inputs(e), o.default.previewEvt(e), o.default.smileEvt(e), "DesertsP" === e.mode && o.default.startEvt(e), void 0 !== e.config.barrager && !e.config.barrager || o.default.barrager(e), o.default.getCache(e), o.default.resetForm(e), o.default.uploadImage(e), o.default.cancelReply(e), o.default.smileBtnEvt(e), o.default.previewBtnEvt(e), o.default.atEvt(e), o.default.submitBtnEvt(e), o.default.smile(e), o.default.visitor(e)
        }, e.exports = a
    }, function (e, t, n) {
        "use strict";
        var i = c(n(11)), o = c(n(13)), r = c(n(14)), a = c(n(15));

        function c(e) {
            return e && e.__esModule ? e : {default: e}
        }

        e.exports = {vcard: i.default, loading: o.default, smiles: r.default, el: a.default}
    }, function (e, t, n) {
        "use strict";
        var i = n(1), o = function (e) {
            return e && e.__esModule ? e : {default: e}
        }(n(12)), r = function (e, t) {
            var n = md5(e.get("mail")), o = "".concat(i.GBUrl + n, "?size=80&d=robohash");
            if (t.enableQQ && 0 <= e.get("mail").indexOf("@qq.com")) {
                var r = e.get("mail").replace(/@.*/, "");
                null !== r.match(/^\d+$/g) && (o = "https://q1.qlogo.cn/g?b=qq&nk=" + r + "&s=100")
            }
            return o
        };
        e.exports = function (e, t) {
            t.set("nick", t.get("nick").slice(0, 20).trim().replace(/&/g, "&amp;").replace(/\//g, "&#x2F").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;"));
            var n = md5(t.get("mail")), i = r(t, e);
            if (void 0 === e.config.barrager || e.config.barrager) try {
                if (window.MV.barrager.enable) {
                    void 0 === window.MV.barrager.bottom && (window.MV.barrager.bottom = $(window).height()), window.MV.barrager.bottom < 60 ? window.MV.barrager.bottom = $(window).height() - 60 : window.MV.barrager.bottom = window.MV.barrager.bottom - 60;
                    var a = {
                        img: i,
                        info: t.get("comment").replace(/<[^>]+>/g, "").replace(/\n/g, "").replace(/\r\n/g, "").slice(0, 25).trim(),
                        href: "#" + t.id,
            ...
            if ("xCss" === e.mode) {
                var c = t.get("ua") || "", l = "";
                if (c && !e.config.closeUA) {
                    c = uaparser(c);
                    var s = "https://cdn.jsdelivr.net/gh/MiniValine/svg@master/";
                    try {
                        if (c.browser && c.browser.name) {
                            l += '<span class="vsys"><i><embed class="msvg" src="' + s;
                            var u = c.browser.name.toLowerCase();
                            ["samsung browser"].includes(u) ? l += "mobile-alt" : ["android browser"].includes(u) ? l += "android" : ["mobile safari", "safari"].includes(u) ? l += "safari" : ["ie", "iemobile"].includes(u) ? l += "internet-explorer" : ["wechat"].includes(u) ? l += "weixin" : ["qqbrowser", "qqbrowserlite", "qq"].includes(u) ? l += "qq" : ["baiduboxapp", "baidu"].includes(u) ? l += "paw" : ["chrome", "chromium", "chrome headless", "chrome webview"].includes(u) ? l += "chrome" : ["opera mobi", "opera", "opera coast", "opera mini", "opera tablet"].includes(u) ? l += "opera" : ["firefox", "edge"].includes(u) ? l += u : l += "snapchat-ghost", l += '.svg"/></i>' + c.browser.name + " " + (c.browser.version ? c.browser.version : "") + "</span> "
                        } else l += '<span class="vsys"><i><embed class="msvg" src="' + s + 'stars.svg"/></i>Magical APP</span>';
                        if (c.os && c.os.name) {
                            l += '<span class="vsys"><i><embed class="msvg" src="' + s;
                            var d = c.os.name.toLowerCase();
                            ["mac os", "ios"].includes(d) ? l += "apple" : ["chromium os"].includes(d) ? l += "chrome" : ["firefox os"].includes(d) ? l += "firefox" : ["windows phone", "windows"].includes(d) ? l += "windows" : ["android", "linux", "ubuntu", "suse", "redhat", "fedora", "centos", "blackberry"].includes(d) ? l += d : l += "snapchat-ghost", l += '.svg"/></i>' + c.os.name + " " + (c.os.version ? c.os.version : "") + "</span>"
                        } else l += '<span class="vsys"><i><embed class="msvg" src="' + s + 'magic.svg"/></i>Magical OS</span>';
                        if (e.config.region) try {
                            var f = t.get("log").region.data.location;
                            f && (l += '<span class="vsys"><i><embed class="msvg" src="' + s + 'map.svg"/></i>' + f + "</span>")
                        } catch (e) {
                        }
                    } catch (e) {
                    }
        ...
        e.exports = function (e, t) {
            try {
                var n = e.getTime(), o = (new Date).getTime() - n, r = Math.floor(o / 864e5);
                if (0 !== r) return r < 0 ? t.now : r < 365 ? "".concat(r, " ").concat(t.days) : i(e);
                var a = o % 864e5, c = Math.floor(a / 36e5);
                if (0 !== c) return "".concat(c, " ").concat(t.hours);
                var l = a % 36e5, s = Math.floor(l / 6e4);
                if (0 !== s) return "".concat(s, " ").concat(t.minutes);
                var u = l % 6e4, d = Math.round(u / 1e3);
        ...
        e.exports = function (e) {
            var t = setInterval((function () {
                if (void 0 !== e.emoticonList && 0 != e.emoticonList.length) {
                    clearInterval(t);
                    for (var n = e.el.querySelector(".vsmile-icons ul"), i = e.el.querySelector(".vsmile-bar ul"), o = e.emoticonList || [], r = 0; r < o.length; r++) {
                        for (var a = document.createElement("li"), c = document.createElement("li"), l = 0; l < o[r].length; l++) {
                            var s = document.createElement("img");
                            s.setAttribute("data-src", "".concat(o[r][l])), s.setAttribute("class", "lazyload");
                            try {
                                a.appendChild(s)
                            } catch (e) {
                            }
                            if (0 === l) {
                                (s = document.createElement("img")).setAttribute("src", "".concat(o[r][0])), s.removeAttribute("class", "lazyload");
                                try {
                                    c.appendChild(s)
                                } catch (e) {
                                }
        ...
        "use strict";
        var i = L(n(17)), o = L(n(18)), r = L(n(19)), a = L(n(20)), c = L(n(21)), l = L(n(23)), s = L(n(24)),
            u = L(n(25)), d = L(n(26)), f = L(n(5)), v = L(n(27)), m = L(n(28)), p = L(n(29)), g = L(n(30)),
            h = L(n(31)), y = L(n(32)), b = L(n(33)), w = L(n(34)), M = L(n(35)), x = L(n(36)), C = L(n(39)),
            S = L(n(40)), _ = L(n(41)), q = L(n(42)), A = L(n(43)), k = L(n(44)), V = L(n(45)), E = L(n(46));
        ...
        var i18n = function i18n(root) {
            if (window.MV.i18n) root.i18n = window.MV.i18n, window.MV.getI18n = 0; else {
        ...
        e.exports = function (e) {
            ...
            t = e.config.serverURLs || n, void 0 === window.disableAVInit && (AV.init({
                appId: e.config.appId,
                appKey: e.config.appKey,
                serverURLs: t
            }), window.disableAVInit = !0), e.v = AV
        }
    }, function (module, exports, __webpack_require__) {
        "use strict";
        ...
        e.exports = function (e) {
            e.config.NoRecordIP || (void 0 === window.MV.ip ? (0, r.default)(e) : e.C.ip = window.MV.ip), void 0 === window.MV.pf && ((0, o.default)(i.pf), window.MV.pf = !0), void 0 !== e.config.barrager && !e.config.barrager || void 0 !== window.MV.jq || ("undefined" == typeof jQuery && (0, o.default)("https://cdn.jsdelivr.net/npm/jquery"), window.MV.jq = !0), void 0 !== e.visitor && !e.visitor || (0, o.default)("https://cdn.jsdelivr.net/npm/fingerprintjs2")
        }
    }, function (module, exports, __webpack_require__) {
        "use strict";
        var _ajax = __webpack_require__(2), _ajax2 = _interopRequireDefault(_ajax);
        ...
        e.exports = function (e) {
            var t = setInterval((function () {
                "undefined" != typeof Promise && (clearInterval(t), "DesertsP" === e.mode ? n.e(8).then(n.t.bind(null, 50, 7)) : "xCss" === e.mode && n.e(11).then(n.t.bind(null, 51, 7)), void 0 !== e.config.danmu && !e.config.danmu || n.e(9).then(n.t.bind(null, 52, 7)), e.config.dark && n.e(10).then(n.t.bind(null, 53, 7)))
            }), 5)
        }
    }, function (e, t, n) {
        "use strict";
        e.exports = function (e) {
            var t = setInterval((function () {
                "undefined" != typeof Promise && (clearInterval(t), Promise.all([n.e(13), n.e(4)]).then(n.t.bind(null, 54, 7)).then((function (t) {
                    (0, t.lib)(), e.initCheck()
                })))
            }), 5)
        }
        ...
        e.exports = function (e) {
            ...
            i.default.on("keydown", document, (function (n) {
                ...
                (n.ctrlKey || n.metaKey) && 13 === i && e.submitEvt(), 9 !== i || "veditor" == (document.activeElement.className || "") && (n.preventDefault(), (0, o.default)(t, "    "))
            }));
            var n = function (n) {
                if (n.length) for (var i = function () {
                    var i = n[a], c = "![Uploading ".concat(i.name, "]()");
                    (0, o.default)(t, c), r(i, (function (n, o) {
                        !n && o && (t.value = t.value.replace(c, "\r\n![".concat(i.name, "](").concat(o.data.url, ")")), e.C.comment = t.value)
                    }))
                }, a = 0; a < n.length; a++) i()
            };
            i.default.on("paste", document, (function (e) {
                var t = "clipboardData" in e ? e.clipboardData : e.originalEvent && e.originalEvent.clipboardData || window.clipboardData,
                    i = t && t.items, o = [];
                if (i && 0 < i.length) {
                    for (var r = 0; r < i.length; r++) if (-1 !== i[r].type.indexOf("image")) {
                        o.push(i[r].getAsFile());
                        break
                    }
                    n(o)
                }
            ...
            e.alert = {
                show: function (n) {
                    ...
                    var o = t.querySelector(".vbtns"),
                        r = '<button class="vcancel vbtn">'.concat(n.ctxt || e.i18n.cancel, "</button>"),
                        a = '<button class="vsure vbtn">'.concat(n.otxt || e.i18n.continue, "</button>");
                    if (o.innerHTML = "".concat(r).concat(n.type && a), t.querySelector(".vcancel").addEventListener("click", (function (t) {
                        e.alert.hide()
        ...
        e.exports = function (e) {
            ...
            i.notEqualTo("isSpam", !0), i.count().then((function (t) {
        ...
        e.exports = function (e) {
            ...
            i.default.on("click", t, (function (t) {
                var n = e.el.querySelector(".veditor"), i = t.target.src;
                if (void 0 !== i) {
                    var r = "!(:".concat(decodeURI(i).replace(/^.*\/(.*)$/, "$1"), ":)");
                    (0, o.default)(n, r), e.C.comment = n.value;
        ...
        e.exports = function (e) {
            var t = e.el.querySelector(".vsmile-icons"), n = e.el.querySelector(".vpreview-text");
            e.reset = function () {
                for (var o in e.mapping) if (e.mapping.hasOwnProperty(o)) {
                    var r = e.mapping[o];
                    e.el.querySelector(".".concat(o)).value = "", e.C[r] = ""
                }
                e.C.rid = "", e.C.nick = "", e.C.at = "", (e.el.querySelector(".vinputs-area  textarea").placeholder = "", i.default)(e), e.previewEvt(e), t.getAttribute("triggered") && (t.setAttribute("style", "display:none;"), t.removeAttribute("triggered")), n.getAttribute("triggered") && (n.setAttribute("style", "display:none;"), n.removeAttribute("triggered")), e.el.querySelector(".vcancel-comment-reply").setAttribute("style", "display:none");
                try {
        ...
        e.exports = function (e) {
            i.default.on("click", e.el.querySelector(".cancel-reply-btn"), (function (t) {
                e.reset()
            }))
        }
    }, function (e, t, n) {
        ...
        e.exports = function (e) {
            var t = e.el.querySelector(".vemoji-btn"), n = e.el.querySelector(".vpreview-btn"),
                o = e.el.querySelector(".vpreview-text"), r = e.el.querySelector(".vsmile-body");
        ...
        e.exports = function (e) {
            var t = e.el.querySelector(".vpreview-btn"), n = e.el.querySelector(".vemoji-btn"),
                o = e.el.querySelector(".vpreview-text"), r = e.el.querySelector(".vsmile-icons");
            i.default.on("click", t, (function (i) {
                if (r.getAttribute("triggered") && (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), n.classList.remove("actived")), o.getAttribute("triggered")) o.setAttribute("style", "display:none;"), o.removeAttribute("triggered"), t.classList.remove("actived"); else {
        ...
        e.exports = function (e) {
            for (var t in e.inputs = {}, e.mapping = {
                ...
                var n = e.mapping[t], o = e.el.querySelector(".".concat(t));
                e.inputs[n] = o, i.default.on("input", o, (function (t) {
        ...
        e.exports = function (e) {
            e.AtEvt = function (t) {
                var n = t.getAttribute("id"), o = t.querySelector("#at-".concat(n));
                i.default.on("click", o, (function (i) {
                    var r = o.getAttribute("at"), a = o.getAttribute("rid");
        ...
        e.exports = function (e) {
            ...
            e.submitEvt = function (i) {
                if (t.getAttribute("disabled")) e.alert.show({
                    ...
                    ctxt: e.i18n.ok
                }); else if ("" !== e.C.comment) if ("" !== e.C.nick) {
                    (0, o.default)(e, e, (function (e) {
                        ...
                        var i = r.default.mail(e.C.mail), o = r.default.link(e.C.link);
                        e.C.mail = i.k ? i.v : "", e.C.link = o.k ? o.v : "", i.k && o.k ? n() : e.alert.show({
                            type: 0,
                            text: e.i18n.inputTips,
                            ctxt: e.i18n.confirm
                        })
                    }))
                } else e.inputs.nick.focus(); else e.inputs.comment.focus()
            };
            var n = function () {
                t.setAttribute("disabled", !0), e.submitting.show();
                var n = new (e.v.Object.extend("Comment"));
                for (var i in e.C) if (e.C.hasOwnProperty(i)) {
                    if ("at" === i) continue;
                    var o = e.C[i];
                    n.set(i, o)
                }
                ...
                n.setACL(function () {
                ...
                }()), n.save({log: window.MV}).then((function (n) {
                    ...
                    if (i.innerText = Number(i.innerText) + 1, "" === e.C.rid) e.insertComment(n, null, !0); else {
        ...
        e.exports = function (e, t, o) {
            e.md || void 0 === e.config.md ? Promise.all([n.e(14), n.e(6)]).then(n.t.bind(null, 55, 7)).then((function (e) {
                var n = e.markdown;
                t.TEXT = n(t.TEXT), (0, i.default)(t, o)
            })) : (0, i.default)(t, o)
        }
    }, function (e, t, n) {
        "use strict";
        ...
        e.exports = function (e, t) {
            e.insertComment = function (i) {
                ...
                a.setAttribute("class", "vcard"), a.setAttribute("id", i.id), a.innerHTML = t.vcard(e, i), e.ActivateCode(e);
                ...
                if (r) c.insertBefore(a, l[0]); else try {
                    c.appendChild(a)
                } catch (e) {
                }
            ...
            var n = function (e) {
                180 < e.offsetHeight && (e.classList.add("expand"), i.default.on("click", e, (function (t) {
        ...
        e.exports = function (e) {
            e.nestQuery = function (t) {
                var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1,
                    r = t.querySelector(".vcomment-children"), a = r.querySelector(".vlist"), c = t.getAttribute("id");
                n <= 0 && r.setAttribute("style", "margin-left: 0 !important"), n >= e.maxNestLevel ? e.v.Query.doCloudQuery("select count(*) from Comment where rid='".concat(c, "' and (url='").concat(e.C.url, "' or url='", "".concat(e.C.url, "/"), "') order by -createdAt")).then((function (n) {
                    if (0 < n.count) {
                        var o = r.querySelector(".vshow-children-wrapper");
                    ...
                    e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mail, ua ".concat(e.config.region ? ",log" : "", " from Comment where rid='").concat(c, "' and (url='").concat(e.C.url, "' or url='", "".concat(e.C.url, "/"), "') order by -createdAt")).then((function (t) {
                        var i = (t = t && t.results || []).length;
                        if (i) for (var r = function (i) {
                            if (!t[i].get("isSpam")) {
                                t[i].TEXT = t[i].get("comment"), (0, o.default)(t[i], (function (o) {
                                    t[i].set("comment", o.TEXT);
                                    var r = e.insertComment(t[i], a, !0);
                                    e.nestQuery(r, n + 1)
                                }))
                            }
                        }, c = 0; c < i; c++) r(c)
        ...
        e.exports = function (e) {
            ...
            e.parentCount = 0, e.parentQuery = function () {
                ...
                e.loading.show(), e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mail, ua ".concat(e.config.region ? ",log" : "", " from Comment where (rid='' or rid is not exists) and (url='").concat(e.C.url, "' or url='", "".concat(e.C.url, "/"), "') order by -createdAt limit ").concat((n - 1) * e.pageSize, ",").concat(e.pageSize)).then((function (r) {
                    var a = (r = r && r.results || []).length;
                    if (a) {
                        for (var c = function (t) {
                            if (0 == t && e.loading.hide(e.parentCount), r[t].get("isSpam")) return "continue";
                            r[t].TEXT = r[t].get("comment"), (0, o.default)(r[t], (function (n) {
                                r[t].set("comment", n.TEXT);
                                var i = e.insertComment(r[t], e.el.querySelector(".vlist"), !1);
                                i.setAttribute("style", "margin-bottom: .5em"), e.nestQuery(i)
                            }))
                        }, l = 0; l < a; l++) c(l);
                        ...
                        u && i.default.on("click", u, (function (n) {
        ...
        e.exports = function (e) {
            e.ActivateCode = function (e) {
                setTimeout((function () {
                    document.getElementsByTagName("pre").length && n.e(7).then(n.t.bind(null, 57, 7))
                }), 500), 0 != e.math && n.e(5).then(n.t.bind(null, 58, 7)).then((function (t) {
        ...
        e.exports = function (e) {
            e.previewEvt = function (e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
                    n = e.el.querySelector(".vpreview-btn"), o = e.el.querySelector(".vpreview-text"),
                    r = e.el.querySelector(".veditor"), a = function (i) {
        ...
        "use strict";
        e.exports = function (e) {
            void 0 !== e.visitor && !e.visitor || n.e(16).then(n.t.bind(null, 59, 7)).then((function (t) {
                (0, t.MCo)(e.config)
            }))
        }
    }, function (e, t, n) {
        ...
        e.exports = function (e) {
            ...
            t ? (t = JSON.parse(t), window.MV.barrager.url = t.url) : window.MV.barrager.url = [], function (e, t) {
                for (var n = 0; n < e.length; n++) if (t === e[n]) return 1
            }(window.MV.barrager.url, document.location.href) || (window.MV.barrager.url.push(document.location.href), localStorage && localStorage.setItem("MiniValineBarrager", JSON.stringify({url: window.MV.barrager.url})), n.e(1).then(n.t.bind(null, 60, 7)).then((function (e) {
                (0, e.barrager)()
            })))
        }
    }, function (e, t, n) {
        ...
        e.exports = function (e) {
            if (e.config.cloudflag) try {
                e.cloudFlag = {}, AV.Query.doCloudQuery("select * from Roles limit 100000000  order by -createdAt").then((function (t) {
                    ...
                    e.cloudFlag.Users = {};
                    for (var n = 0; n < t.results.length; n++) e.cloudFlag.Users[t.results[n].get("emailhash").toUpperCase()] = t.results[n].get("role")
                }), (function (e) {
                    console.log(e)
                }))
            } catch (e) {
